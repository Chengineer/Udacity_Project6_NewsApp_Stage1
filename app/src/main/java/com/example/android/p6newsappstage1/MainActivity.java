...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
     ...
     */
    private static final String GUARDIAN_REQUEST_URL = "https://content.guardianapis.com/search?order-by=newest&show-fields=thumbnail&show-tags=contributor&page-size=10&api-key=3ca6a8b7-fdc2-491d-9058-a4d9a21501ac";
    /**
